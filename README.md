...
### Что нового:
- ✅ **Standalone режим** для воркеров (без Docker, LXC, VM)
- ✅ **Ban System** — автоматический бан неудачных прокси (настраиваемая длительность)
- ✅ **Сохранение хороших прокси** — прокси не теряются между проверками
- ✅ **Управление подписками** — переключатели ON/OFF, количество конфигов
- ✅ **Исправление Proxies страницы** — данные в правильных колонках
- ✅ **Исправление `'v'` бага** — корректная вставка прокси в БД
